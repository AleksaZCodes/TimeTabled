<template>
  <h1 class="text-4xl font-extrabold leading-10 tracking-tight">
    Terms of Service
  </h1>

  <div class="leading-relaxed">
    Your privacy is important to us. It is ShipFast's policy to respect your
    ...
    used.
    <br /><br />
    You can sign up with your Google account so your ShipFast's account username
    ...
    <br /><br />
    We act in the capacity of a data controller and a data processor with regard
    to the personal data processed through ShipFast and the services in terms of
    the applicable data protection laws, including the EU General Data
...
<script setup>
useHead({
  title: 'Terms of Service | LeanLaunch',
  meta: [{ name: 'description', content: 'LeanLaunch Terms of Service' }]
})
